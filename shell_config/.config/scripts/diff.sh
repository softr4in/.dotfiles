...
# Credits to https://github.com/yannbertrand/macos-defaults/blob/main/diff.sh
# This tool is for detecting changes in defaults syntax due to new OS versions.
# Run this script manually and follow the prompts to capture the latest
# iterations of macOS defaults.
